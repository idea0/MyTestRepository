...
/*	public static JSONObject getJsonObject(String url, HttpHost proxy, int timeout) throws IOException, JSONException {
	 ...
	 *
	 */                                              
    public static Bitmap getHttpBitmap(String url, int timeout) throws IllegalStateException, IOException {
    	HttpResponse response = getHttpResponse(url, null, timeout);
    ...
    public static Bitmap getHttpBitmap(String url, String referer, int timeout) throws IllegalStateException, IOException {
...
public static Bitmap getHttpBitmapWelcomeBg(String url, String referer, int timeout) throws IllegalStateException, IOException {
