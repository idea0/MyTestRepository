 ...
 */
package com.haomee.chat.application;
...
import com.haomee.yocker.MainActivity;
...
public class DemoHXSDKHelper extends HXSDKHelper {
	...
	protected OnMessageNotifyListener getMessageNotifyListener() {
		...
		return new OnMessageNotifyListener() {
			...
			@Override
			public String onLatestMessageNotify(final EMMessage message, int fromUsersNum, int messageNum) {
				// return null;
