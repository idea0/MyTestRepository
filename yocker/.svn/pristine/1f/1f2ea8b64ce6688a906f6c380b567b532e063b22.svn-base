...
import com.haomee.chat.widget.LoadLocalBigImgTask;
import com.haomee.chat.widget.PhotoView;
...
public class ShowBigImage extends BaseActivity {
	...
	private int default_res = R.drawable.fake_icon_film;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.fake_icon_film);
